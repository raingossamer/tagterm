...
const api: TagTermApi = {
  app: {
    ...
    getGlobalShortcut: () => invoke('app:get-global-shortcut'),
  ...
  agent: {
    ...
    getHooksStatus: () => invoke('agent:get-hooks-status'),
    setHooks: (agent, enabled) => invoke('agent:set-hooks', agent, enabled),
